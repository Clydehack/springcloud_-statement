...
public class CsvFileUtil {
	...
	public static void main(String[] args) {
		try {
			analysisCsvInputStreamByJavaCsvUtil("http://116.228.64.55:9093/IMEServer/docroot/attachments/merchantCheck/2019/06/100009001000_20190610_1_allinpay.txt", '|');
	 ...
	 */
	public static Map<String, BillModel> analysisCsvInputStreamByJavaCsvUtil(String fileUrl, char delimiter) throws IOException {
		...
		try {
			...
			*/
			...
			while (csvReader.readRecord()) {
				...
				billModel.setPay_type(csvReader.get("支付方式"));
